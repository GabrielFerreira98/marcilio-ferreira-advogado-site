...
export function NoticeContainer(NoticeProps: NoticeContainer){
    return(
        <div className="bg-white h-2/3 w-96 rounded-xl flex flex-col items-center cursor-pointer hover:translate-y-[-30px] transition 300ms">
            <img className="w-[80%] h-[40%] mt-8 rounded-2xl shadow-xl" src={NoticeProps.url} alt="Notícia" />
